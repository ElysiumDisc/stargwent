# Changelog — v1.0 to v4.9

*Archived from CHANGELOG.md. For latest changes see [CHANGELOG.md](CHANGELOG.md). For middle versions see [CHANGELOG-v5-v8.md](CHANGELOG-v5-v8.md).*

...
ALL_CARDS = {
    ...
    "tauri_turret_1": Card("tauri_turret_1", "Energy Pistol Turret", FACTION_TAURI, 6, "siege", None),
    "tauri_turret_2": Card("tauri_turret_2", "Energy Pistol Turret", FACTION_TAURI, 6, "siege", None),
    "tauri_turret_3": Card("tauri_turret_3", "Energy Pistol Turret", FACTION_TAURI, 6, "siege", None),
    ...
    "goauld_kull_warrior_1": Card("goauld_kull_warrior_1", "Kull Warrior", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_kull_warrior_2": Card("goauld_kull_warrior_2", "Kull Warrior", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_osiris_guard_1": Card("goauld_osiris_guard_1", "Osiris Guard", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_osiris_guard_2": Card("goauld_osiris_guard_2", "Osiris Guard", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_horus_guard_1": Card("goauld_horus_guard_1", "Horus Guard", FACTION_GOAULD, 5, "close", "Life Force Drain"),
    "goauld_horus_guard_2": Card("goauld_horus_guard_2", "Horus Guard", FACTION_GOAULD, 5, "close", "Life Force Drain"),
    "goauld_anubis_guard_1": Card("goauld_anubis_guard_1", "Anubis Guard", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_anubis_guard_2": Card("goauld_anubis_guard_2", "Anubis Guard", FACTION_GOAULD, 4, "close", "Life Force Drain"),
    "goauld_bastet_guard_1": Card("goauld_bastet_guard_1", "Bastet Guard", FACTION_GOAULD, 5, "close", "Life Force Drain"),
    "goauld_bastet_guard_2": Card("goauld_bastet_guard_2", "Bastet Guard", FACTION_GOAULD, 5, "close", "Life Force Drain"),
    "goauld_council_anubis": Card("goauld_council_anubis", "Council of Anubis", FACTION_GOAULD, 6, "close", "System Lord's Curse"),
    "goauld_council_baal": Card("goauld_council_baal", "Council of Ba'al", FACTION_GOAULD, 6, "close", "System Lord's Curse"),
    "goauld_council_yu": Card("goauld_council_yu", "Council of Yu", FACTION_GOAULD, 6, "close", "System Lord's Curse"),
    ...
    "jaffa_master_bratac": Card("jaffa_master_bratac", "Master Bra'tac", FACTION_JAFFA, 10, "ranged", "Legendary Commander"),
    ...
    "jaffa_tokra_infiltrator_1": Card("jaffa_tokra_infiltrator_1", "Tok'ra Infiltrator", FACTION_JAFFA, 4, "close", "Gate Reinforcement"),
    "jaffa_tokra_infiltrator_2": Card("jaffa_tokra_infiltrator_2", "Tok'ra Infiltrator", FACTION_JAFFA, 4, "close", "Gate Reinforcement"),
    "jaffa_tokra_infiltrator_3": Card("jaffa_tokra_infiltrator_3", "Tok'ra Infiltrator", FACTION_JAFFA, 4, "close", "Gate Reinforcement"),
    ...
    "jaffa_ashrak_recruit": Card("jaffa_ashrak_recruit", "Ashrak Recruit", FACTION_JAFFA, 2, "ranged", None),
    ...
    "jaffa_zat_op": Card("jaffa_zat_op", "Zat'nik'tel Operative", FACTION_JAFFA, 4, "ranged", None),
    ...
    "jaffa_shalchek_leader": Card("jaffa_shalchek_leader", "Shal'chek Leader", FACTION_JAFFA, 2, "ranged", "Inspiring Leadership"),

...
ALL_CARDS = {
    ...
    "asgard_energy_drone_1": Card("asgard_energy_drone_1", "Energy Drone", FACTION_ASGARD, 8, "siege", None),
    "asgard_energy_drone_2": Card("asgard_energy_drone_2", "Energy Drone", FACTION_ASGARD, 8, "siege", None),

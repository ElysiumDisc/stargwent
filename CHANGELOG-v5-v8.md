# Changelog — v5.0 to v8.8

*Archived from CHANGELOG.md. For latest changes see [CHANGELOG.md](CHANGELOG.md). For earlier versions see [CHANGELOG-v1-v4.md](CHANGELOG-v1-v4.md).*
